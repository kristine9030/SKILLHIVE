 ...
 * Tables/columns used: endorsement(endorsement_id, application_id, adviser_id, status, reviewed_at, created_at), application(application_id, student_id, internship_id), student(student_id, first_name, last_name, department), internship(internship_id, title, employer_id), employer(employer_id, company_name).
 */
