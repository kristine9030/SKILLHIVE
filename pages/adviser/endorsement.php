...
<style>
  ...
  <div class="analytics-title-header" style="margin-bottom:32px;">
    <h2 class="analytics-page-title" style="font-size:2rem;">Endorsement Review Hub</h2>
    <p class="analytics-page-subtitle" style="font-size:0.95rem;margin-top:10px;">Endorsement confirms that a student is academically prepared and has the required documents for internship deployment.</p>
  </div>
  ...
  <div class="stat-cards">
    <div class="stat-card adviser-stat-pending">
      <div class="stat-card-icon"><img src="/SkillHive/assets/media/Active%20Posting.png" alt="Pending Review"></div>
      <div class="stat-card-info">
        <div class="stat-card-num-row">
          <div class="stat-card-trend neutral"><?php echo $pendingCount; ?> pending</div>
          <div class="stat-card-num"><?php echo $pendingCount; ?></div>
        </div>
        <div class="stat-card-label">Pending Review</div>
      </div>
    </div>
    <div class="stat-card adviser-stat-approved">
      <div class="stat-card-icon"><img src="/SkillHive/assets/media/Total%20Applicants.png" alt="Approved"></div>
      <div class="stat-card-info">
        <div class="stat-card-num-row">
          <div class="stat-card-trend neutral"><?php echo $approvedCount; ?> approved</div>
          <div class="stat-card-num"><?php echo $approvedCount; ?></div>
        </div>
        <div class="stat-card-label">Approved</div>
      </div>
    </div>
    <div class="stat-card adviser-stat-rejected">
      <div class="stat-card-icon"><img src="/SkillHive/assets/media/Interviews.png" alt="Rejected"></div>
      <div class="stat-card-info">
        <div class="stat-card-num-row">
          <div class="stat-card-trend neutral"><?php echo $rejectedCount; ?> rejected</div>
          <div class="stat-card-num"><?php echo $rejectedCount; ?></div>
        </div>
        <div class="stat-card-label">Rejected</div>
      </div>
    </div>
    <div class="stat-card adviser-stat-total">
      <div class="stat-card-icon"><img src="/SkillHive/assets/media/Hiredd.png" alt="Total Endorsements"></div>
      <div class="stat-card-info">
        <div class="stat-card-num-row">
          <div class="stat-card-trend neutral"><?php echo $totalThisTerm; ?> total</div>
          <div class="stat-card-num"><?php echo $totalThisTerm; ?></div>
        </div>
        <div class="stat-card-label">Total Endorsements</div>
      </div>
    </div>
  </div>
